...
import com.humanheima.hmsimplebanner.transformer.BGAPageTransformer;
import com.humanheima.hmsimplebanner.transformer.TransitionEffect;
import com.humanheima.hmsimplebanner.util.ScreenUtil;
...
public class SuperCopyBanner extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initViewPager() {
        ...
        addView(viewPager, 0, new RelativeLayout.LayoutParams(RMP, RMP));
    }
